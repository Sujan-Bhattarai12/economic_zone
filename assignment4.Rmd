...
##Plot suitabale areas by region `comb` and full zone)
#v_rasterized <- rasterize(combined_v_areas_under, suitable_for_sucker)
library(ggmap)
library(basemaps)
